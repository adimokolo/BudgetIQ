    ...
    >
      ...
      {result !== null && !error && (
        <div style={{ marginTop: 12, textAlign: "center" }}>
          <div
            style={{ fontSize: 13, color: "var(--ink-faint)", marginBottom: 4 }}
          >
...
export default function AddTransactionModal({
  ...
  const handleSubmit = async (e) => {
    ...
    if (!accountExists) {
      setError(
        "The selected account is no longer available. Please select an account again.",
      );
      return;
    }
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="field">
            ...
            <CustomSelect
              value={form.type}
              onChange={(val) =>
                setForm({ ...form, type: val, categoryId: "" })
              }
              options={[
          ...
          <div className="field">
            ...
            <div
              ...
              style={{
                ...
                alignItems: "center",
                fontSize: 14.5,
                color: selectedAccount ? "var(--ink)" : "var(--ink-faint)",
              }}
            >
              <span>
                {selectedAccount
                ...
                return (
                  ...
                  >
                    <span
                      ...
                      style={{
                        background: category.color || "var(--surface-strong)",
                      }}
                    >
                      {getIcon(category.icon || fallbackIconFor(form.type))}
                    </span>
