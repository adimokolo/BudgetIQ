...
export default function Settings() {
  ...
  const handleSelectCurrency = async (code) => {
    ...
    try {
      ...
      setCurrencyError(
        err.response?.data?.error || "Could not update currency.",
      );
    } finally {
  ...
  const handleDeleteAccount = async (e) => {
    ...
    try {
      ...
      setDeleteError(
        err.response?.data?.error || "Could not delete your account.",
      );
    } finally {
      setDeleting(false);
    }
  ...
  return (
    <div className="settings-page">
      ...
      <div className="facet-card settings-profile-card">
        ...
        >
          {avatarUrl ? (
            ...
            <span className="avatar-fallback avatar-fallback--large">
              {initials}
            </span>
          )}
      ...
      <div className="facet-card" style={{ marginTop: 18 }}>
        ...
        <p className="section-subtitle">
          Changes how amounts are displayed going forward. Past transactions are
          not converted.
        </p>
        <button
      ...
      <div className="facet-card" style={{ marginTop: 18, marginBottom: 40 }}>
        <h3 className="section-title" style={{ color: "var(--expense)" }}>
          Delete account
        </h3>
        <p className="section-subtitle">
          This permanently deletes your account and all of your transactions,
          budgets, and categories. This cannot be undone.
        </p>
        <button
          className="btn btn--danger"
          style={{ marginTop: 14 }}
        ...
        >
          ...
          >
            ...
            <p className="section-subtitle">
              ...
              transactions, budgets, categories, and accounts.{" "}
              <strong>This cannot be undone.</strong> Enter your password to
              confirm.
            </p>
